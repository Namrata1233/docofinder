        ...
        <form action="" id="manage-appointment">
            ...
            <div class="form-group">
                ...
                <select class="browser-default custom-select select2" name="doctor_id">
                    ...
                    <option value="<?php echo $row['id'] ?>"
                        <?php echo isset($doctor_id) && $doctor_id == $row['id'] ? 'selected' : '' ?>>
                        <?php echo "DR. ".$row['name'].', '.$row['name'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <?php endif; ?>
            <div class="form-group">
                ...
                <select class="browser-default custom-select select2" name="patient_id">
                    ...
                    <option value="<?php echo $row['id'] ?>"
                        <?php echo isset($patient_id) && $patient_id == $row['id'] ? 'selected' : '' ?>>
            ...
            <div class="col-md-12 text-center">
                <button class="btn-primary btn btn-sm col-md-4">Add</button>
